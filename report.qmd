...
**Calibration:** 
The model’s predicted probabilities are fairly accurate, the Brier score **Brier ≈ 0.21** shows that the model’s predictions are reasonably well aligned with reality. We also tried a method called Platt calibration, which fine-tunes probability estimates to make them more realistic, but it didn’t noticeably improve results. If we ever need more precise probability estimates, we could apply that adjustment again later. 