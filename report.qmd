...
- **Logistic Regression (L2):**  
  Chosen as the primary baseline because it is highly interpretable — each coefficient represents the direction and strength of association between a survey feature and prediabetes likelihood.  
  This transparency makes it suitable for healthcare settings, where practitioners must explain decisions.  
...
- **Random Forest** and **HistGradientBoosting:**  
  Included to test whether nonlinear interactions (e.g., how age and sleep jointly influence metabolic risk) could outperform linear methods.  
  These models capture complex relationships that might be missed by logistic regression but are less interpretable, making them secondary candidates for deployment in healthcare contexts.
